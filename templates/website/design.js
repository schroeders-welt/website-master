    ...
    cx.contentElementGroup
      ...
      .withContentElements(
        require('@bsi-cx/design-standard-library-web/content-elements/form/form-container')
          .withExtendedDropzone(
            'form-container-dropzone-zsY6UI',
            require('./../shared/content-elements/hl_button'),
            require('./../shared/content-elements/friendly-captcha'))
          .withExtendedDropzone(
            'form-container-dropzone-btn-left-Q2L32x',
            require('./../shared/content-elements/hl_button'))
          .withExtendedDropzone(
            'form-container-dropzone-btn-right-uIS6Nj',
            require('./../shared/content-elements/hl_button'))
          .withExtendedDropzone(
            'form-container-dropzone-bottom-cJFI8U',
            require('./../shared/content-elements/hl_button')),
