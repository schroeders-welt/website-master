...
module.exports = {
  ...
  primaryColor: css.color('#2e4674'),
  secondaryColor: css.color('#575c6c'),
  darkColor: css.color('#002d5d'),
  lightColor: css.color('#ffffff'),
  infoColor: css.color('#faaf42'),
  ...
  /* --------------------- Title font family --------------------- */
  titleH1FontFamily: 'Roboto,sans-serif',
  titleH2FontFamily: 'Roboto,sans-serif',
  titleH3FontFamily: 'Roboto,sans-serif',
  ...
  titleH1Color: 'bsi-text-secondary-color',
  titleH2Color: 'bsi-text-secondary-color',
  titleH3Color: 'bsi-text-secondary-color',
